...
* **Technical Bug Log:** View the full list of system defects and replication steps in the [BUG_REPORT_LOG.md](./BUG_REPORT_LOG.md) file.
* **Evidence Captures:** View the system console errors attached in the repository files above.
